...
NEW: Advanced VIU & Total Cost of Ownership (TCO) Procurement Optimizer.
"""
...
tab1, tab2, tab3, tab4 = st.tabs(["📉 Price Forecast", "📊 Market Comparison", "🔀 Regime & Drivers", "🏭 VIU Procurement Optimizer"])
...
with tab4:
    ...
    # Smart Fetch: Attempts to grab latest AI predictions from all 3 folders automatically
    ...
    # Convert subset to numeric for safe styling
