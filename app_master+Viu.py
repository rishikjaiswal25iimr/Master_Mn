...
# UPDATED: Hardcoded default base fallbacks
...
def compute_operational_penalty(thermal, cycle, rec_diff, reblow, clean, yield_loss, rh, eff_mn, price):
    # CRITICAL: 1 MT of Alloy supports 200T of steel. Heat size is 190T.
    # Penalties calculated "per Heat" must be scaled to equal 1 MT of Alloy.
    ...
    # Recovery (Already scaled naturally to 1 MT alloy)
    ...
    # Cleanliness & Yield (Calculated directly per 200T of steel)
